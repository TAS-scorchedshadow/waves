      ...
      >
        ...
        <p
          className="not-italic font-semibold leading-9
                     lg:mt-[20px] lg:text-[40px]
                     md:mt-[13.5px] md:text-[22.5px]"
        >
          {getUserProfileAPI.data?.name}
        </p>
        <p
          className="not-italic font-normal leading-[20px] opacity-70 
                      lg:mt-[20px] lg:text-[20px]
                      md:mt-[13.5px] md:text-[11.25px]"
        >
          {getUserProfileAPI.data?.email}
        </p>
        <hr
